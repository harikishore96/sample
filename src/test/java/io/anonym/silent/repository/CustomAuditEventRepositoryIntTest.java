package io.anonym.silent.repository;

import io.anonym.silent.SampleApp;
import io.anonym.silent.config.Constants;
import io.anonym.silent.config.audit.AuditEventConverter;
import io.anonym.silent.domain.PersistentAuditEvent;
...
import static io.anonym.silent.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
